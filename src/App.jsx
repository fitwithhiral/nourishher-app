...
The grocery_list must reflect ALL ingredients used across ALL ${totalDays} days in this plan.`;
  ...
  try {
    ...
    // STREAMING: backend now returns Server-Sent Events to beat Vercel's 25s
    // timeout. We read chunks as they arrive and assemble the final response.
    const r = await fetch("/api/generate-plan", {
      ...
      body: JSON.stringify({
        prompt: p,
        max_tokens: weekOnly ? 12000 : (isPaid ? 14000 : 12000)
      })
    });
    ...
    // Read the SSE stream. We accumulate frames and only care about the
    // final `done` event, which contains the full response in the same
    // shape as before (content + stop_reason + usage). Progress events
    // are ignored — they exist only to keep the connection alive.
    let d = null;
    ...
    try {
      ...
      while (true) {
        ...
        for (const frame of frames) {
          ...
          try {
            ...
            // "start" and "progress" events are ignored
          } catch (_) {
      ...
      dwarn("❌ Stream read failed:", streamReadErr.message);
      return null;
    }

    if (streamError) {
      dwarn("❌ Stream reported error:", streamError);
      return null;
    }
    if (!d) {
      dwarn("❌ Stream ended without 'done' event");
      return null;
    }
...
function makeFallback(a, isPaid = false) {
  ...
  const templates = {
    "Non-Vegetarian": [
      [{time:"Breakfast",name:"Egg White Veggie Omelette",emoji:"🍳",cal:340,protein:"28g",carbs:"18g",fat:"16g",prep_time:"12 min",desc:"Fluffy egg whites with spinach, mushroom, and feta",ingredients:["4 egg whites + 1 whole egg","1/2 cup chopped spinach","1/4 cup sliced mushrooms","2 tbsp crumbled feta","1 tbsp olive oil","1/4 tsp salt","1/8 tsp black pepper"],instructions:["Whisk eggs with salt and pepper","Sauté spinach and mushrooms in olive oil 3 min","Pour eggs over veggies, cook until set","Fold omelette, top with feta"]},{time:"Lunch",name:"Grilled Chicken Quinoa Bowl",emoji:"🥗",cal:540,protein:"42g",carbs:"48g",fat:"16g",prep_time:q?"20 min":"30 min",desc:"Herb-marinated chicken over quinoa with roasted veggies",ingredients:["150g chicken breast","1 cup cooked quinoa","1 cup mixed roasted veggies","2 tbsp olive oil","1 tbsp lemon juice","2 cloves minced garlic","1 tsp mixed herbs"],instructions:["Marinate chicken in olive oil, lemon, garlic, herbs 15 min","Grill chicken 6-7 min each side","Cook quinoa per package","Assemble bowl with sliced chicken and veggies"]},{time:"Snack",name:"Greek Yogurt & Almonds",emoji:"🥄",cal:180,protein:"18g",carbs:"14g",fat:"6g",prep_time:"3 min",desc:"High-protein yogurt with crunchy almonds and honey",ingredients:["1 cup plain Greek yogurt","15 raw almonds","1 tsp honey"],instructions:["Scoop yogurt into bowl","Top with almonds and honey drizzle"]},{time:"Dinner",name:"Butter Chicken with Brown Rice",emoji:"🍛",cal:520,protein:"36g",carbs:"52g",fat:"18g",prep_time:q?"20 min":"40 min",desc:"Creamy tomato-based chicken curry with aromatic spices",ingredients:["200g chicken thigh, cubed","1 cup tomato puree","2 tbsp butter","2 tbsp heavy cream","1 tsp garam masala","1/2 tsp turmeric","1/2 tsp chilli powder","1 cup cooked brown rice"],instructions:["Marinate chicken in yogurt and spices 10 min","Sauté ginger-garlic, add tomato puree and spices","Add chicken, cook 15 min until tender","Stir in butter and cream, serve over rice"]}],
      [{time:"Breakfast",name:"Turkey Sausage Breakfast Wrap",emoji:"🌯",cal:380,protein:"30g",carbs:"32g",fat:"14g",prep_time:"10 min",desc:"Whole wheat wrap with turkey sausage, scrambled eggs, avocado",ingredients:["2 turkey sausage links","2 large eggs","1 whole wheat tortilla","1/4 medium avocado, sliced","1/2 tsp olive oil"],instructions:["Cook turkey sausage in pan 5 min and slice","Scramble eggs with olive oil","Warm tortilla 20 sec","Layer sausage, eggs, avocado, roll up"]},{time:"Lunch",name:"Chicken Tikka Salad",emoji:"🥗",cal:480,protein:"38g",carbs:"28g",fat:"22g",prep_time:"25 min",desc:"Spiced grilled chicken over greens with yogurt dressing",ingredients:["150g chicken breast, cubed","1/4 cup plain yogurt","2 tsp tikka masala","3 cups mixed greens","1/2 cucumber, diced","1 medium tomato, diced","2 tbsp mint yogurt dressing"],instructions:["Marinate chicken in yogurt and tikka masala 15 min","Grill until charred and cooked through, 10 min","Toss greens with cucumber and tomato","Top with chicken and dressing"]},{time:"Snack",name:"Protein Shake",emoji:"🥤",cal:200,protein:"24g",carbs:"22g",fat:"4g",prep_time:"3 min",desc:"Quick protein shake with banana and almond milk",ingredients:["1 scoop (30g) whey protein","1 medium banana","1 cup unsweetened almond milk"],instructions:["Blend all ingredients until smooth","Pour and enjoy immediately"]},{time:"Dinner",name:"Salmon Teriyaki with Stir-Fry",emoji:"🐟",cal:500,protein:"34g",carbs:"42g",fat:"20g",prep_time:q?"20 min":"30 min",desc:"Glazed salmon with colorful vegetable stir-fry",ingredients:["150g salmon fillet","2 tbsp teriyaki sauce","1 cup mixed stir-fry veggies","1/2 cup cooked brown rice","1 tsp sesame seeds","1 tsp sesame oil"],instructions:["Brush salmon with teriyaki sauce","Pan-sear 4 min each side","Stir-fry vegetables in sesame oil 5 min","Serve salmon over rice with veggies and sesame seeds"]}]
    ],
    "Pescatarian": [
      [{time:"Breakfast",name:"Smoked Salmon Avocado Toast",emoji:"🥑",cal:380,protein:"22g",carbs:"34g",fat:"18g",prep_time:"8 min",desc:"Whole grain toast with smoked salmon, avocado, capers",ingredients:["2 slices whole grain bread","60g smoked salmon","1/2 medium avocado","1 tbsp capers","1 tsp lemon juice","1 tsp fresh dill"],instructions:["Toast bread until golden","Mash avocado with lemon juice and spread on toast","Layer smoked salmon on top","Garnish with capers, dill, and a lemon squeeze"]},{time:"Lunch",name:"Shrimp Poke Bowl",emoji:"🍤",cal:520,protein:"32g",carbs:"56g",fat:"14g",prep_time:q?"15 min":"25 min",desc:"Marinated shrimp over sushi rice with edamame and avocado",ingredients:["150g cooked shrimp","1 cup cooked sushi rice","1/2 medium avocado","1/2 cup shelled edamame","2 tbsp soy sauce","1 tsp sesame oil","1 tsp sesame seeds"],instructions:["Cook sushi rice and season with rice vinegar","Toss shrimp with soy sauce and sesame oil","Assemble bowl with rice, shrimp, avocado, edamame","Top with sesame seeds"]},{time:"Snack",name:"Cottage Cheese & Berries",emoji:"🫐",cal:170,protein:"16g",carbs:"18g",fat:"4g",prep_time:"3 min",desc:"High-protein cottage cheese topped with fresh berries",ingredients:["1 cup low-fat cottage cheese","1/2 cup mixed berries","1 tsp honey"],instructions:["Scoop cottage cheese into bowl","Top with berries and honey"]},{time:"Dinner",name:"Baked Cod with Roasted Veggies",emoji:"🐟",cal:460,protein:"36g",carbs:"38g",fat:"16g",prep_time:q?"20 min":"35 min",desc:"Herb-crusted cod with seasonal roasted vegetables",ingredients:["150g cod fillet","1 medium zucchini, sliced","1 bell pepper, sliced","2 tbsp olive oil","1 tbsp lemon juice","2 cloves garlic","1 medium sweet potato, cubed","1 tsp mixed herbs"],instructions:["Season cod with 1 tbsp olive oil, lemon, garlic, herbs","Toss veggies and sweet potato with remaining oil, roast at 400°F 20 min","Add cod, bake 12-15 min more","Serve together with lemon squeeze"]}],
      [{time:"Breakfast",name:"Protein Smoothie Bowl",emoji:"🥣",cal:360,protein:"24g",carbs:"42g",fat:"12g",prep_time:"10 min",desc:"Thick berry smoothie with protein, granola, seeds",ingredients:["1 cup frozen berries","1 scoop (30g) protein powder","1/2 medium banana","1/2 cup Greek yogurt","1/4 cup granola","1 tbsp shredded coconut"],instructions:["Blend berries, protein, banana, yogurt until thick","Pour into bowl","Top with granola and coconut"]},{time:"Lunch",name:"Tuna Nicoise Salad",emoji:"🥗",cal:490,protein:"34g",carbs:"32g",fat:"22g",prep_time:"20 min",desc:"Classic French salad with tuna, eggs, olives, green beans",ingredients:["1 can (150g) tuna in olive oil","2 hard-boiled eggs","1 cup green beans, blanched","1 cup cherry tomatoes","8 black olives","6 baby potatoes, boiled","2 tbsp Dijon vinaigrette"],instructions:["Boil eggs (10 min) and potatoes, blanch green beans 3 min","Arrange greens on plate","Top with tuna, halved eggs, potatoes, beans, olives","Drizzle with vinaigrette"]},{time:"Snack",name:"Trail Mix & Dark Chocolate",emoji:"🥜",cal:190,protein:"8g",carbs:"20g",fat:"10g",prep_time:"2 min",desc:"Almonds, walnuts, cranberries with dark chocolate",ingredients:["2 tbsp mixed nuts (almonds + walnuts)","1 tbsp dried cranberries","1 tbsp dark chocolate chips (70%)"],instructions:["Mix ingredients together","Portion into small bowl"]},{time:"Dinner",name:"Garlic Butter Shrimp Pasta",emoji:"🍝",cal:520,protein:"30g",carbs:"56g",fat:"18g",prep_time:q?"18 min":"25 min",desc:"Sautéed shrimp in garlic butter over whole wheat pasta",ingredients:["150g shrimp, peeled","100g whole wheat pasta (dry)","3 cloves garlic, minced","2 tbsp butter","1/4 tsp chilli flakes","2 tbsp chopped parsley","1/2 cup cherry tomatoes"],instructions:["Cook pasta al dente per package","Sauté garlic in butter 1 min, add chilli","Cook shrimp 2-3 min per side","Toss pasta with shrimp, tomatoes, parsley"]}]
    ],
    "Pollotarian": [
      [{time:"Breakfast",name:"Chicken & Veggie Breakfast Bowl",emoji:"🍲",cal:380,protein:"32g",carbs:"30g",fat:"14g",prep_time:"15 min",desc:"Shredded chicken with eggs, spinach, sweet potato",ingredients:["80g shredded cooked chicken","2 large eggs","1/2 cup baby spinach","1/2 medium sweet potato, cubed","1 tbsp olive oil","1/4 tsp salt","1/4 tsp black pepper"],instructions:["Roast sweet potato cubes 15 min at 400°F","Scramble eggs with salt and pepper in olive oil","Wilt spinach in same pan","Combine with chicken in bowl"]},{time:"Lunch",name:"Lemon Herb Chicken Salad",emoji:"🥗",cal:480,protein:"40g",carbs:"30g",fat:"18g",prep_time:q?"15 min":"25 min",desc:"Grilled chicken over greens with quinoa and lemon dressing",ingredients:["150g chicken breast","1/2 cup cooked quinoa","3 cups mixed greens","1/2 cucumber, sliced","2 tbsp olive oil","1 tbsp lemon juice","1 tsp Dijon mustard","1 tsp dried herbs"],instructions:["Marinate chicken in olive oil, lemon, herbs 10 min","Grill 6-7 min each side, slice","Whisk dressing (oil + lemon + Dijon)","Toss greens with quinoa, cucumber, chicken, dressing"]},{time:"Snack",name:"Greek Yogurt with Honey",emoji:"🥄",cal:170,protein:"16g",carbs:"18g",fat:"4g",prep_time:"2 min",desc:"Thick Greek yogurt with honey and walnuts",ingredients:["1 cup plain Greek yogurt","1 tsp honey","6 walnut halves"],instructions:["Scoop yogurt into bowl","Drizzle with honey","Top with walnuts"]},{time:"Dinner",name:"Chicken Stir-Fry with Brown Rice",emoji:"🥘",cal:520,protein:"38g",carbs:"54g",fat:"16g",prep_time:q?"18 min":"30 min",desc:"Quick stir-fry with bell peppers, broccoli, and ginger soy sauce",ingredients:["150g chicken breast, sliced","1 cup broccoli florets","1 bell pepper, sliced","1 cup cooked brown rice","2 tbsp soy sauce","1 tbsp grated ginger","2 cloves garlic","1 tbsp sesame oil"],instructions:["Heat sesame oil, stir-fry chicken 5 min","Add ginger, garlic, cook 1 min","Add veggies, stir-fry 5 min","Add soy sauce, serve over rice"]}],
      [{time:"Breakfast",name:"Chicken Sausage Avocado Toast",emoji:"🥑",cal:400,protein:"28g",carbs:"34g",fat:"18g",prep_time:"10 min",desc:"Whole grain toast with chicken sausage and avocado",ingredients:["2 slices whole grain bread","2 chicken sausage links","1/2 medium avocado","1 large egg","1/4 tsp red pepper flakes","Salt and pepper to taste"],instructions:["Cook chicken sausage 5 min, slice","Toast bread until golden","Mash avocado, spread on toast","Top with sausage, fried egg, red pepper flakes"]},{time:"Lunch",name:"Chicken Caesar Wrap",emoji:"🌯",cal:490,protein:"36g",carbs:"40g",fat:"18g",prep_time:"15 min",desc:"Grilled chicken with romaine, parmesan, Caesar dressing",ingredients:["150g grilled chicken breast, sliced","1 whole wheat tortilla","2 cups chopped romaine","2 tbsp grated parmesan","2 tbsp Caesar dressing","1 tbsp lemon juice"],instructions:["Grill chicken and slice","Toss romaine with Caesar dressing and parmesan","Layer chicken and salad in tortilla","Squeeze lemon, roll up tightly"]},{time:"Snack",name:"Protein Smoothie",emoji:"🥤",cal:200,protein:"22g",carbs:"24g",fat:"4g",prep_time:"3 min",desc:"Banana protein smoothie with almond milk",ingredients:["1 scoop (30g) whey protein","1 medium banana","1 cup unsweetened almond milk","1 tsp peanut butter"],instructions:["Blend all ingredients until smooth","Pour and serve immediately"]},{time:"Dinner",name:"Chicken Tikka Masala",emoji:"🍛",cal:540,protein:"36g",carbs:"52g",fat:"18g",prep_time:q?"22 min":"40 min",desc:"Creamy tomato chicken curry with basmati rice",ingredients:["180g chicken thigh, cubed","1/4 cup plain yogurt","1 cup tomato puree","2 tbsp butter","2 tbsp heavy cream","1 tbsp tikka masala spice","1 tsp ginger-garlic paste","1 cup cooked basmati rice"],instructions:["Marinate chicken in yogurt and spices 15 min","Sauté ginger-garlic, add tomato puree","Add chicken, cook 15 min until tender","Stir in butter and cream, serve over rice"]}]
    ],
    "Vegan": [
      [{time:"Breakfast",name:"Tofu Scramble with Avocado Toast",emoji:"🌱",cal:380,protein:"24g",carbs:"36g",fat:"16g",prep_time:"12 min",desc:"Spiced tofu scramble with avocado on whole grain toast",ingredients:["150g firm tofu, crumbled","1/2 medium avocado","2 slices whole grain bread","1/4 tsp turmeric","1/4 tsp black salt (kala namak)","1 tbsp olive oil","1/4 cup chopped spinach","2 tbsp nutritional yeast"],instructions:["Heat olive oil, sauté spinach 2 min","Add crumbled tofu, turmeric, black salt","Cook 5 min until heated through","Toast bread, top with mashed avocado","Serve tofu scramble alongside toast"]},{time:"Lunch",name:"Chickpea Buddha Bowl",emoji:"🥗",cal:520,protein:"22g",carbs:"68g",fat:"16g",prep_time:q?"18 min":"30 min",desc:"Roasted chickpeas, quinoa, veggies, tahini dressing",ingredients:["1 cup cooked chickpeas","1 cup cooked quinoa","1 cup mixed roasted veggies","2 cups mixed greens","2 tbsp tahini","1 tbsp lemon juice","1 tsp maple syrup","1 tbsp olive oil"],instructions:["Cook quinoa per package","Roast chickpeas with spices at 400°F 20 min","Whisk tahini, lemon, maple, water for dressing","Arrange bowl with quinoa, chickpeas, veggies, greens","Drizzle with tahini dressing"]},{time:"Snack",name:"Vegan Trail Mix",emoji:"🥜",cal:180,protein:"6g",carbs:"22g",fat:"10g",prep_time:"2 min",desc:"Mixed nuts, seeds, and dried fruit",ingredients:["2 tbsp raw almonds","1 tbsp walnuts","1 tbsp pumpkin seeds","1 tbsp dried cranberries","1 tbsp dark chocolate chips (vegan)"],instructions:["Combine all ingredients in bowl","Portion into snack-size container"]},{time:"Dinner",name:"Tofu Stir-Fry with Brown Rice",emoji:"🥘",cal:490,protein:"24g",carbs:"56g",fat:"18g",prep_time:q?"18 min":"35 min",desc:"Crispy tofu with broccoli in soy ginger sauce",ingredients:["180g firm tofu, cubed","1 cup broccoli florets","1 bell pepper, sliced","1 cup cooked brown rice","2 tbsp soy sauce","1 tbsp grated ginger","2 cloves garlic, minced","1 tbsp sesame oil","1 tsp maple syrup"],instructions:["Press tofu 10 min, cube, pan-fry 8 min until golden","Stir-fry veggies in sesame oil on high heat 5 min","Whisk soy, ginger, garlic, maple as sauce","Toss everything together, serve over rice"]}],
      [{time:"Breakfast",name:"Overnight Oats with Berries",emoji:"🫙",cal:340,protein:"14g",carbs:"56g",fat:"10g",prep_time:"5 min + overnight",desc:"Creamy oats with plant milk, chia, and mixed berries",ingredients:["1/2 cup rolled oats","3/4 cup unsweetened oat milk","1 tbsp chia seeds","1/2 cup mixed berries","2 tbsp sliced almonds","1 tsp maple syrup","1/4 tsp vanilla extract"],instructions:["Combine oats, oat milk, chia, maple, vanilla in jar","Refrigerate overnight (8+ hours)","Top with berries and almonds before eating"]},{time:"Lunch",name:"Black Bean Burrito Bowl",emoji:"🌮",cal:510,protein:"20g",carbs:"72g",fat:"14g",prep_time:q?"15 min":"25 min",desc:"Black beans, brown rice, corn, salsa, guacamole",ingredients:["1 cup cooked black beans","1 cup cooked brown rice","1/2 cup corn kernels","1/4 cup salsa","1/2 medium avocado","1 tbsp lime juice","2 tbsp chopped cilantro","1/2 tsp cumin"],instructions:["Warm beans with cumin 5 min","Mash avocado with lime juice for guacamole","Assemble bowl: rice base, beans, corn, salsa, guacamole","Top with cilantro"]},{time:"Snack",name:"Protein Energy Balls (Vegan)",emoji:"🟤",cal:190,protein:"8g",carbs:"24g",fat:"8g",prep_time:"10 min",desc:"Dates, oats, peanut butter, plant protein",ingredients:["6 medjool dates, pitted","1/4 cup rolled oats","2 tbsp natural peanut butter","1 tbsp plant protein powder","1 tbsp ground flaxseed"],instructions:["Blend dates and oats in food processor","Mix in peanut butter, protein, flax","Roll into 6 balls, refrigerate 30 min"]},{time:"Dinner",name:"Red Lentil Coconut Curry",emoji:"🍲",cal:470,protein:"22g",carbs:"60g",fat:"14g",prep_time:q?"20 min":"35 min",desc:"Creamy coconut red lentil curry over rice",ingredients:["1 cup red lentils","1 cup light coconut milk","1 medium onion, chopped","3 cloves garlic","1 inch ginger, grated","1 tbsp curry powder","1 tsp turmeric","1 cup cooked basmati rice","2 tbsp chopped cilantro"],instructions:["Sauté onion, garlic, ginger with curry powder 5 min","Add lentils, coconut milk, 2 cups water","Simmer 20 min until lentils break down","Serve over rice, garnish with cilantro"]}]
    ],
    "Jain": [
      // Jain diet: No onion, garlic, potato, carrots, beetroot, ginger root, or any root vegetables
      // No eggs. Dairy is okay. Asafoetida (hing) is used instead of onion/garlic.
      [{time:"Breakfast",name:"Jain Poha",emoji:"🍚",cal:340,protein:"12g",carbs:"54g",fat:"10g",prep_time:"15 min",desc:"Flattened rice with peas, peanuts, and lemon",ingredients:["1 cup flattened rice (poha)","1/2 cup green peas","2 tbsp peanuts","2 tbsp grated coconut","1 tbsp lemon juice","1 tsp mustard seeds","6 curry leaves","1/4 tsp asafoetida (hing)","1 tbsp oil","2 green chillies, slit","1/4 tsp turmeric"],instructions:["Rinse poha briefly, drain","Heat oil, add mustard seeds, curry leaves, hing","Add peanuts, peas, green chillies, turmeric","Mix in poha gently, cook 3 min","Garnish with coconut and lemon juice"]},{time:"Lunch",name:"Jain Khichdi",emoji:"🍛",cal:480,protein:"22g",carbs:"68g",fat:"12g",prep_time:q?"20 min":"30 min",desc:"Comforting one-pot rice and moong dal with ghee",ingredients:["1/2 cup rice","1/2 cup yellow moong dal","1 cup pumpkin or bottle gourd, cubed","1 tbsp ghee","1 tsp cumin seeds","1/4 tsp asafoetida (hing)","1/4 tsp turmeric","1 tsp salt","2 cloves","1/4 cup yogurt (optional)"],instructions:["Wash rice and dal, soak 15 min","Pressure cook with vegetables, turmeric, salt for 3 whistles","Heat ghee, add cumin, hing, cloves","Pour tadka over khichdi, serve with yogurt"]},{time:"Snack",name:"Jain Dhokla",emoji:"🟡",cal:180,protein:"12g",carbs:"24g",fat:"5g",prep_time:"20 min",desc:"Steamed chickpea flour cake with green chilli chutney",ingredients:["1 cup chickpea flour (besan)","1/2 cup yogurt","1/2 cup water","1 tsp Eno fruit salt","1/4 tsp asafoetida (hing)","1 tsp mustard seeds","6 curry leaves","2 green chillies","2 tbsp chopped coriander","1/2 tsp salt"],instructions:["Mix besan, yogurt, water, salt, hing into smooth batter","Add Eno, pour into greased plate","Steam 12-15 minutes","Heat oil, add mustard seeds, curry leaves, green chillies","Pour tadka over dhokla, garnish with coriander"]},{time:"Dinner",name:"Jain Pumpkin Curry with Rotli",emoji:"🥘",cal:460,protein:"16g",carbs:"56g",fat:"16g",prep_time:q?"22 min":"35 min",desc:"Spiced pumpkin curry with whole wheat flatbread",ingredients:["2 cups pumpkin, cubed","1 cup tomato puree","2 tbsp ghee","1/4 tsp asafoetida (hing)","1 tsp cumin seeds","1/2 tsp turmeric","1 tsp coriander powder","1/2 tsp red chilli powder","2 cups whole wheat flour (for 4 rotli)","1 tbsp jaggery","Salt to taste"],instructions:["Heat ghee, add cumin and hing","Add tomato puree and spices, cook 5 min","Add pumpkin and 1/2 cup water, simmer 15 min until tender","Add jaggery, salt, mix well","Make rotli dough with whole wheat flour and water","Roll thin, cook on tawa, serve with curry"]}],
      [{time:"Breakfast",name:"Sabudana Khichdi",emoji:"🥮",cal:380,protein:"10g",carbs:"58g",fat:"14g",prep_time:"15 min + soaking",desc:"Tapioca pearls with peanuts and green chillies",ingredients:["1 cup sabudana (tapioca pearls), soaked overnight","1/4 cup roasted peanuts, crushed","2 tbsp grated coconut","2 green chillies, chopped","1 tbsp ghee","1 tsp cumin seeds","1 tbsp lemon juice","2 tbsp chopped coriander","1/2 tsp salt","1 tsp sugar"],instructions:["Drain soaked sabudana","Heat ghee, add cumin and green chillies","Add sabudana, peanuts, salt, sugar","Cook stirring gently 5-7 min until translucent","Garnish with coconut, coriander, lemon juice"]},{time:"Lunch",name:"Jain Paneer Bhurji with Rotli",emoji:"🥬",cal:520,protein:"28g",carbs:"42g",fat:"22g",prep_time:q?"18 min":"30 min",desc:"Scrambled paneer with tomatoes and spices",ingredients:["200g paneer, crumbled","2 medium tomatoes, chopped","1 tbsp ghee","1 tsp cumin seeds","1/4 tsp asafoetida (hing)","1/2 tsp turmeric","1 tsp coriander powder","1/2 tsp garam masala","2 green chillies, chopped","2 tbsp chopped coriander","2 whole wheat rotli"],instructions:["Heat ghee, add cumin and hing","Add tomatoes, green chillies, and dry spices","Cook 5 min until tomatoes soften","Add crumbled paneer, cook 3-4 min","Garnish with coriander, serve with rotli"]},{time:"Snack",name:"Mathri with Chai",emoji:"🥨",cal:200,protein:"6g",carbs:"24g",fat:"10g",prep_time:"5 min",desc:"Crispy whole wheat crackers with cardamom tea",ingredients:["4 small mathri","1 cup milk","2 tsp tea leaves","2 cardamom pods, crushed","1 tsp sugar (optional)","1 cup water"],instructions:["Boil water with tea leaves and cardamom 3 min","Add milk and sugar, simmer 2 min","Strain into cup","Serve hot with mathri"]},{time:"Dinner",name:"Bhindi Masala with Bajra Rotla",emoji:"🌿",cal:480,protein:"16g",carbs:"58g",fat:"18g",prep_time:q?"22 min":"35 min",desc:"Spiced okra stir-fry with millet flatbread",ingredients:["300g fresh okra (bhindi), sliced","2 medium tomatoes, chopped","2 tbsp oil","1 tsp cumin seeds","1/4 tsp asafoetida (hing)","1/2 tsp turmeric","1 tsp coriander powder","1/2 tsp red chilli powder","1 cup bajra (millet) flour","Salt to taste"],instructions:["Wash and dry okra well, slice into rings","Heat oil, add cumin and hing","Add okra, sauté on medium-high 10 min until crispy","Add tomatoes and spices, cook 5 min more","Mix bajra flour with warm water, salt to make dough","Roll thick rotla, cook on tawa with ghee","Serve okra with rotla"]}]
    ],
    "gujarati": [
      [{time:"Breakfast",name:"Moong Dal Chilla",emoji:"🥞",cal:360,protein:"22g",carbs:"38g",fat:"12g",prep_time:"15 min",desc:"Savory lentil crepes with mint-coriander chutney",ingredients:["1 cup yellow moong dal, soaked overnight","1/2 medium onion, chopped","2 green chillies, chopped","2 tbsp chopped coriander","1/4 tsp turmeric","1/2 tsp salt","2 tbsp oil for cooking"],instructions:["Blend soaked dal with chillies and ginger into smooth batter","Add onions, coriander, turmeric, salt","Heat tawa, spread thin batter into circle","Drizzle oil, cook both sides until golden","Serve with mint chutney"]},{time:"Lunch",name:"Gujarati Dal-Rice",emoji:"🍛",cal:520,protein:"26g",carbs:"62g",fat:"16g",prep_time:q?"20 min":"35 min",desc:"Sweet-tangy toor dal with rice, papad, and salad",ingredients:["1 cup toor dal","1 cup basmati rice","2 tbsp jaggery","1 tbsp lemon juice","1 tsp mustard seeds","1 tsp cumin seeds","6 curry leaves","1/4 tsp asafoetida","1 tbsp ghee","1/2 tsp turmeric","Salt to taste"],instructions:["Pressure cook dal with turmeric, tomato, and 3 cups water","Add jaggery, lemon juice, salt to dal","Cook rice separately","Heat ghee, add mustard, cumin, curry leaves, hing","Pour tadka into dal, simmer 5 min","Serve with rice and papad"]},{time:"Snack",name:"Dhokla with Chutney",emoji:"🟡",cal:180,protein:"14g",carbs:"22g",fat:"4g",prep_time:"15 min",desc:"Steamed chickpea flour cake with green chutney",ingredients:["1 cup chickpea flour (besan)","1/2 cup yogurt","1/2 cup water","1 tsp Eno fruit salt","1/2 tsp turmeric","1 tsp mustard seeds","6 curry leaves","2 green chillies","2 tbsp chopped coriander","1 tbsp oil"],instructions:["Mix besan, yogurt, water, turmeric into smooth batter","Add Eno, pour into greased plate","Steam 12-15 minutes","Heat oil with mustard seeds, curry leaves, chillies","Pour tadka over dhokla, garnish with coriander"]},{time:"Dinner",name:"Undhiyu with Bajra Rotla",emoji:"🥘",cal:480,protein:"24g",carbs:"48g",fat:"18g",prep_time:q?"25 min":"40 min",desc:"Traditional mixed vegetable casserole with millet flatbread",ingredients:["1 small purple yam, cubed","1 raw banana, cubed","1 brinjal, cubed","100g green beans","100g papdi (flat beans)","1/2 cup grated coconut","1/4 cup chopped coriander","6 cloves garlic","2 inch ginger","3 green chillies","2 cups bajra flour","2 tbsp oil","Salt to taste"],instructions:["Blend coconut, coriander, garlic, ginger, chillies into masala","Layer veggies in pot with masala","Cook covered on low flame 30 min","Make rotla dough with bajra flour and warm water","Pat rotla thick, cook on tawa with ghee","Serve undhiyu with fresh bajra rotla"]}],
      [{time:"Breakfast",name:"Thepla with Chai",emoji:"🫓",cal:340,protein:"18g",carbs:"44g",fat:"12g",prep_time:"15 min",desc:"Spiced fenugreek flatbread with masala tea",ingredients:["1 cup whole wheat flour","1/2 cup chopped fresh fenugreek (methi)","1/4 cup yogurt","1/4 tsp turmeric","1/2 tsp red chilli powder","1/2 tsp ajwain seeds","1/2 tsp salt","2 tbsp oil","1 cup water"],instructions:["Mix fenugreek with flour, yogurt, and spices","Knead soft dough with water, rest 10 min","Roll thin, cook on tawa with oil","Serve warm with chai and pickle"]},{time:"Lunch",name:"Dal Dhokli",emoji:"🍲",cal:490,protein:"22g",carbs:"58g",fat:"14g",prep_time:"35 min",desc:"Wheat flour dumplings cooked in spiced dal",ingredients:["1/2 cup toor dal","1 cup whole wheat flour","2 tbsp peanuts","2 tbsp jaggery","1 tbsp kokum (or tamarind)","1 tsp mustard seeds","1 tsp cumin seeds","6 curry leaves","2 green chillies","1/2 tsp turmeric","Salt to taste"],instructions:["Cook toor dal with peanuts until soft","Make dough from wheat flour and spices, rest 10 min","Roll thin, cut into diamond shapes","Add dough pieces to boiling dal with jaggery and kokum","Simmer 15 min until dhokli are tender"]},{time:"Snack",name:"Handvo",emoji:"🧁",cal:200,protein:"12g",carbs:"28g",fat:"6g",prep_time:"20 min",desc:"Savory mixed lentil and rice cake",ingredients:["1 cup handvo batter (rice + chana + toor dal)","1 cup grated bottle gourd","1 tbsp sesame seeds","1 tsp mustard seeds","1/4 tsp asafoetida","1 inch ginger, grated","2 green chillies","1 tbsp oil","1/2 tsp salt"],instructions:["Mix batter with grated gourd, ginger, chillies, salt","Pour into greased pan","Sprinkle sesame seeds on top","Cook covered on low heat 15 min until golden","Cut into pieces, serve with chutney"]},{time:"Dinner",name:"Pav Bhaji",emoji:"🍞",cal:460,protein:"20g",carbs:"52g",fat:"16g",prep_time:"30 min",desc:"Spiced mashed vegetable curry with buttered pav",ingredients:["2 medium potatoes, boiled","1/2 cup cauliflower, boiled","1/2 cup green peas, boiled","2 medium tomatoes, chopped","1 medium onion, chopped","2 tbsp pav bhaji masala","2 tbsp butter","1 tbsp lemon juice","4 pav buns","2 tbsp chopped coriander"],instructions:["Boil and mash potatoes, cauliflower, peas","Sauté onions and tomatoes with pav bhaji masala 8 min","Add mashed veggies, 1 tbsp butter, cook 10 min","Toast pav with remaining butter","Serve garnished with onion, lemon, coriander"]}]
    ],
    "default": [
      // Default = Lacto-Vegetarian, Lacto-Ovo Veg, Eggetarian (dairy/eggs allowed)
      [{time:"Breakfast",name:"Protein Spinach Smoothie",emoji:"🥣",cal:360,protein:"22g",carbs:"38g",fat:"12g",prep_time:"10 min",desc:"Spinach, banana, protein powder, chia, almond butter",ingredients:["1 cup baby spinach","1 medium banana","1 scoop (30g) protein powder","1 tbsp chia seeds","1 tbsp almond butter","1 cup unsweetened almond milk","1/2 cup ice"],instructions:["Add all ingredients to blender","Blend high speed 1 min until smooth","Pour into glass and enjoy"]},{time:"Lunch",name:"Chickpea Buddha Bowl",emoji:"🥗",cal:520,protein:"26g",carbs:"62g",fat:"16g",prep_time:q?"18 min":"30 min",desc:"Roasted chickpeas, quinoa, veggies, tahini dressing",ingredients:["1 cup cooked chickpeas","1 cup cooked quinoa","1 cup mixed roasted veggies","2 cups mixed greens","2 tbsp tahini","1 tbsp lemon juice","1 tsp honey","1 tbsp olive oil","1/4 tsp cumin"],instructions:["Cook quinoa per package","Toss chickpeas with cumin, roast at 400°F 20 min","Whisk tahini, lemon, honey, water for dressing","Arrange bowl with quinoa, chickpeas, veggies, greens","Drizzle with tahini dressing"]},{time:"Snack",name:"Cottage Cheese & Berries",emoji:"🫐",cal:180,protein:"16g",carbs:"20g",fat:"4g",prep_time:"3 min",desc:"Low-fat cottage cheese with berries and honey",ingredients:["1 cup low-fat cottage cheese","1/2 cup mixed berries","1 tsp honey","1 tbsp chopped almonds"],instructions:["Scoop cottage cheese into bowl","Top with berries, honey, and almonds"]},{time:"Dinner",name:"Paneer Tikka Wrap",emoji:"🌯",cal:480,protein:"24g",carbs:"48g",fat:"18g",prep_time:q?"18 min":"35 min",desc:"Grilled paneer in wrap with mint raita",ingredients:["150g paneer, cubed","1 whole wheat tortilla","2 tbsp tikka masala","2 tbsp plain yogurt","1/4 medium onion, sliced","1/4 bell pepper, sliced","2 tbsp mint raita","1 tbsp chopped coriander"],instructions:["Marinate paneer in yogurt and tikka masala 15 min","Pan-grill paneer 5 min until charred","Warm tortilla 20 sec","Layer paneer, onion, pepper in wrap","Drizzle with raita, sprinkle coriander, roll up"]}],
      [{time:"Breakfast",name:"Overnight Protein Oats",emoji:"🫙",cal:340,protein:"18g",carbs:"44g",fat:"12g",prep_time:"5 min + overnight",desc:"Oats soaked with yogurt, chia, mango, almonds",ingredients:["1/2 cup rolled oats","1/2 cup Greek yogurt","1 tbsp chia seeds","1/2 cup mango, cubed","2 tbsp sliced almonds","1/4 cup milk","1 tsp honey"],instructions:["Combine oats, yogurt, chia, milk, honey in jar","Refrigerate overnight (8+ hours)","Top with mango and almonds before eating"]},{time:"Lunch",name:"Palak Paneer with Roti",emoji:"🥬",cal:510,protein:"26g",carbs:"48g",fat:"18g",prep_time:q?"20 min":"30 min",desc:"Spinach paneer curry with whole wheat roti",ingredients:["150g paneer, cubed","3 cups fresh spinach","1 medium onion, chopped","3 cloves garlic","1 inch ginger","2 tbsp cream","1 tsp garam masala","1/2 tsp cumin","1 tbsp ghee","2 whole wheat roti","Salt to taste"],instructions:["Blanch spinach 2 min, blend into smooth puree","Sauté onion, garlic, ginger in ghee 5 min","Add spinach puree and spices, simmer 5 min","Add paneer and cream, cook 5 min","Serve with warm roti"]},{time:"Snack",name:"Protein Energy Balls",emoji:"🟤",cal:200,protein:"14g",carbs:"22g",fat:"8g",prep_time:"10 min",desc:"Dates, oats, peanut butter, protein powder",ingredients:["6 medjool dates, pitted","1/4 cup rolled oats","2 tbsp natural peanut butter","1 scoop (30g) protein powder","1 tbsp honey","1 tbsp mini chocolate chips"],instructions:["Blend dates and oats in food processor","Mix in peanut butter, protein, honey","Fold in chocolate chips","Roll into 6 balls, refrigerate 30 min"]},{time:"Dinner",name:"Veggie Lentil Soup",emoji:"🍲",cal:460,protein:"22g",carbs:"58g",fat:"10g",prep_time:q?"20 min":"35 min",desc:"Red lentil soup with cumin and garlic bread",ingredients:["1 cup red lentils","1 medium onion, chopped","2 medium carrots, diced","2 medium tomatoes, chopped","3 cloves garlic","1 tsp cumin","1/2 tsp turmeric","1 tbsp olive oil","2 slices whole wheat bread","4 cups vegetable broth","2 tbsp chopped parsley"],instructions:["Heat olive oil, sauté onion, garlic, carrots 5 min","Add lentils, tomatoes, broth, cumin, turmeric","Simmer 20 min until lentils break down","Toast bread, rub with garlic","Garnish soup with parsley, serve with bread"]}]
    ]
  };

  // Diet key selection — match user's diet to proper template
  let key = "default";
  if (guj) {
    key = "gujarati"; // Gujarati cuisine overrides
  } else if (nv) {
    key = "Non-Vegetarian";
  } else if (pesc) {
    key = "Pescatarian";
    ...
    key = "Jain";
  } else if (diet === "Pollotarian") {
    key = "Pollotarian";
  }
  // else: Lacto-Vegetarian, Lacto-Ovo Vegetarian, Eggetarian → use "default" template (dairy + eggs ok)
  ...
  const groceryByDiet = {
    "Non-Vegetarian": [
      {category:"🥬 Fresh Produce",items:["Spinach (2 bunches)","Broccoli (2 heads)","Bell peppers (4)","Mushrooms (250g)","Tomatoes (6)","Onions (1 kg)","Avocados (3)","Bananas (6)","Lemons (4)","Mixed greens (2 bags)","Garlic (1 head)","Ginger (50g)"]},
      {category:"🍗 Proteins",items:["Chicken breast (600g)","Chicken thighs (400g)","Turkey sausage (1 pack)","Salmon fillet (300g)","Eggs (12)","Greek yogurt (1 kg)","Whey protein (1 tub)","Feta cheese (200g)"]},
      {category:"🌾 Grains",items:["Brown rice (1 kg)","Quinoa (500g)","Whole wheat wraps (1 pack)","Oats (500g)"]},
      {category:"🥜 Pantry",items:["Olive oil","Teriyaki sauce","Garam masala","Almond butter","Raw almonds (250g)","Honey","Butter (250g)","Heavy cream (200ml)","Tikka masala spice","Salt, pepper"]},
    ],
    "Pescatarian": [
      {category:"🥬 Fresh Produce",items:["Mixed greens (2 bags)","Cherry tomatoes","Avocados (4)","Zucchini (3)","Bell peppers (4)","Bananas (6)","Berries (2 packs)","Lemons (6)","Fresh dill (1 bunch)","Fresh parsley (1 bunch)","Sweet potato (2)","Cucumber (2)"]},
      {category:"🐟 Seafood & Protein",items:["Salmon fillet (300g)","Cod fillet (300g)","Shrimp (400g)","Smoked salmon (150g)","Canned tuna in olive oil (2)","Eggs (12)","Greek yogurt (1 kg)","Cottage cheese (500g)","Feta (200g)"]},
      {category:"🌾 Grains",items:["Quinoa (500g)","Sushi rice (500g)","Brown rice (1 kg)","Whole wheat pasta (500g)","Oats (500g)","Whole grain bread (1 loaf)"]},
      {category:"🥜 Pantry",items:["Olive oil","Sesame oil","Soy sauce","Tahini","Dijon mustard","Mixed nuts (250g)","Edamame (frozen)","Granola (500g)","Capers","Sesame seeds","Black olives"]},
    ],
    "Pollotarian": [
      {category:"🥬 Fresh Produce",items:["Mixed greens (2 bags)","Baby spinach (2 bunches)","Broccoli (2 heads)","Bell peppers (4)","Tomatoes (6)","Sweet potato (2)","Avocados (3)","Bananas (6)","Lemons (4)","Cucumber (2)","Garlic (1 head)","Ginger (50g)","Romaine lettuce (2)"]},
      {category:"🍗 Proteins",items:["Chicken breast (800g)","Chicken thighs (400g)","Chicken sausage (1 pack)","Eggs (12)","Greek yogurt (1 kg)","Whey protein (1 tub)","Parmesan cheese (100g)"]},
      {category:"🌾 Grains",items:["Brown rice (1 kg)","Quinoa (500g)","Basmati rice (500g)","Whole wheat tortillas","Whole grain bread"]},
      {category:"🥜 Pantry",items:["Olive oil","Sesame oil","Soy sauce","Tikka masala spice","Garam masala","Caesar dressing","Honey","Almond butter","Peanut butter","Almond milk","Walnuts (100g)","Salt, pepper"]},
    ],
    "Vegan": [
      {category:"🥬 Fresh Produce",items:["Spinach (2 bunches)","Broccoli (2 heads)","Bell peppers (4)","Tomatoes (6)","Onions (4)","Avocados (3)","Bananas (6)","Mixed berries (2 packs)","Lemons (4)","Limes (2)","Mango (2)","Mixed greens (2 bags)","Carrots (4)","Garlic (1 head)","Ginger (50g)","Fresh cilantro (1 bunch)"]},
      {category:"🫘 Plant Proteins",items:["Firm tofu (800g)","Chickpeas (3 cans)","Black beans (2 cans)","Red lentils (500g)","Plant-based yogurt (500g)","Plant protein powder (1 tub)"]},
      {category:"🌾 Grains",items:["Quinoa (500g)","Brown rice (1 kg)","Rolled oats (500g)","Whole grain bread (1 loaf)"]},
      {category:"🥜 Pantry",items:["Almond butter","Peanut butter","Tahini","Chia seeds","Ground flax","Pumpkin seeds","Sliced almonds","Walnuts","Medjool dates","Maple syrup","Nutritional yeast","Light coconut milk (2 cans)","Oat milk (1L)","Almond milk (1L)","Olive oil","Sesame oil","Soy sauce","Curry powder","Dark chocolate chips (vegan)","Dried cranberries"]},
    ],
    "Jain": [
      {category:"🥬 Jain-Approved Produce",items:["Pumpkin (1 small, 500g)","Bottle gourd (1 medium)","Okra/Bhindi (300g)","Brinjal/Eggplant (2)","Green peas (200g)","Tomatoes (8)","Spinach (2 bunches)","Fresh fenugreek/Methi (1 bunch)","Fresh coriander (2 bunches)","Green chillies (10)","Lemons (4)","Bananas (6)","Mango (2)"]},
      {category:"🥛 Dairy",items:["Plain yogurt (500g)","Paneer (400g)","Milk (1L)","Ghee (250g)","Butter (200g)"]},
      {category:"🌾 Grains & Lentils",items:["Basmati rice (1 kg)","Whole wheat flour (1 kg)","Bajra flour (500g)","Yellow moong dal (500g)","Toor dal (500g)","Rolled oats (500g)","Sabudana/Tapioca (500g)","Flattened rice/Poha (500g)","Chickpea flour/Besan (500g)"]},
      {category:"🌶 Jain Pantry",items:["Asafoetida/Hing","Cumin seeds","Mustard seeds","Curry leaves (1 bunch)","Turmeric powder","Red chilli powder","Coriander powder","Garam masala","Pav bhaji masala","Jaggery (250g)","Peanuts (250g)","Cashews (100g)","Sesame seeds","Grated coconut (fresh or dry)","Eno fruit salt","Kokum","Cardamom","Cloves","Cooking oil","Tea leaves","Salt"]},
    ],
    "default": [
      {category:"🥬 Fresh Produce",items:["Spinach (2 bunches)","Broccoli (2 heads)","Bell peppers (4)","Tomatoes (6)","Onions (4)","Avocados (3)","Bananas (6)","Mixed berries (2 packs)","Lemons (4)","Mango (2)","Mixed greens (2 bags)","Carrots (4)","Garlic (1 head)","Ginger (50g)"]},
      {category:"🫘 Proteins",items:[veg?"Firm tofu (800g)":"Paneer (400g)","Chickpeas (3 cans)","Red lentils (500g)",veg?"Plant yogurt (500g)":"Greek yogurt (1 kg)",veg?"":"Cottage cheese (500g)",veg?"":"Eggs (12)","Black beans (2 cans)"].filter(Boolean)},
      {category:"🌾 Grains",items:["Quinoa (500g)","Brown rice (1 kg)","Rolled oats (500g)","Whole wheat wraps (1 pack)","Whole wheat bread (1 loaf)","Basmati rice (500g)"]},
      {category:"🥜 Pantry",items:["Almond butter","Tahini","Chia seeds","Peanut butter","Protein powder","Medjool dates (250g)","Honey","Soy sauce","Olive oil","Sliced almonds","Walnuts","Tikka masala spice","Garam masala","Vegetable broth"]},
    ],
  };

  const gKey = nv?"Non-Vegetarian":pesc?"Pescatarian":(diet === "Pollotarian")?"Pollotarian":(diet === "Vegan")?"Vegan":(diet === "Jain")?"Jain":"default";
